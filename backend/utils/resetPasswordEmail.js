                        ...
                        <tbody><tr>
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-size:20px;font-weight:700;line-height:30px;text-align:left;color:#000AFF;">
                              <h1 style="font-family: 'Segoe UI', sans-serif;margin: 0; font-size: 32px; line-height: 50px; font-weight: 700;">Hello, ${name}</h1>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family: 'Segoe UI', sans-serif;font-size:20px;font-weight:500;line-height:30px;text-align:left;color:#000000;">We have received a password change request for your LinkBowl Account</div>
                          </td>
                        </tr>
                        <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                              <tbody><tr>
                                <td align="center" bgcolor="#FFFFFF" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#FFFFFF;" valign="middle">
                                  <a href="${url}"style="display: inline-block; background: #E87A7A; color: white; font-family: 'Segoe UI', sans-serif; font-size: 18px; font-weight: normal; line-height: 30px; margin:0; text-decoration: none; text-transform: none; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 5px;font-weight:700" target="_blank">Reset Your Password</a>
                                </td>
                              </tr>
                            </tbody></table>
                          </td>
...
const sendResetEmail = async options => {
    ...
    var mailOptions = {
        from: "LinkBowl",
        to: options.emailId,
        subject: 'Reset Password | LinkBowl',
        html: addHTML(options.verifyUrl,options.name)
    };
